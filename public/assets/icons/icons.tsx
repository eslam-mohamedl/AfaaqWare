...
const FaFacebookF = (props: IconProps) => (
  <Icon icon="mdi:facebook" {...props} />
);
const FaInstagram = (props: IconProps) => (
  <Icon icon="mdi:instagram" {...props} />
);
const FaYoutube = (props: IconProps) => <Icon icon="mdi:youtube" {...props} />;
const FaSnapchatGhost = (props: IconProps) => (
  <Icon icon="mdi:snapchat" {...props} />
);
...
const MdLocationOn = (props: IconProps) => (
  <Icon icon="mdi:map-marker" {...props} />
);
